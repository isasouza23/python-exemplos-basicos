...
class FormularioInscricao:
    ...
    def enviar(self):
        # Atualidade a labels com os dados coletados 
        self.nome_label.config(text=f"Nome: {self.nome_entry.get()}")
        self.email_label.config(text=f"Nome: {self.nome_entry.get()}")
        self.idade_label.config(text=f"Nome: {self.nome_entry.get()}")
